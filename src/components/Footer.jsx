const socials = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/isabelle-usuquen-986427421/',
    icon: (
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@isabelle.usuquen?_r=1&_t=ZT-984N27cGbhF',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@isabelleusuquen8126?si=6-G5eSZl29Lkvfff',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/isabelleusuquen?utm_source=qr',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
